...
# Use public Lottie animation URLs
lottie_approve = load_lottieurl("https://assets10.lottiefiles.com/packages/lf20_yr6zz3wv.json")  # green check
lottie_deny = load_lottieurl("https://assets10.lottiefiles.com/packages/lf20_jtbfg2nb.json")    # red cross
...
if st.button("Predict Loan Approval"):
    ...
    try:
        ...
        st.error(f"Prediction error: {e}") streamlit as st
import pandas as pd
import numpy as np
import joblib
import datetime
